...
//int main(int argc, char *argv[]){
	enum weather_code {
		...
		dense_freezing_drizzle = 57, slight_rain = 61, moderate_rain = 63, 
		heavy_rain = 65, light_freezing_rain = 66, heavy_freezing_rain = 67, 
		slight_snowfall = 71, moderate_snowfall = 73, heavy_snowfall = 75, 
		snow_grains = 77, slight_rain_showers = 80, moderate_rain_showers = 81, 
